...
/turf/return_air()
	...
	GM.adjust_multi("oxygen", oxygen, "carbon_dioxide", carbon_dioxide, "nitrogen", nitrogen, "phoron", toxins)
...
/turf/remove_air(amount as num)
	...
	if(sum>0)
		...
		GM.gas["phoron"] = (toxins/sum)*amount
...
/turf/proc/make_air()
	...
	air.adjust_multi("oxygen", oxygen, "carbon_dioxide", carbon_dioxide, "nitrogen", nitrogen, "phoron", toxins)
